...
const COLOR_CFG = {
  blue:    { icon:"rgba(79,142,247,0.15)",  iconText:"#4f8ef7",  bar:"#4f8ef7",  glow:"rgba(79,142,247,0.2)"  },
  violet:  { icon:"rgba(167,139,250,0.15)", iconText:"#a78bfa",  bar:"#a78bfa",  glow:"rgba(167,139,250,0.2)" },
  amber:   { icon:"rgba(251,191,36,0.15)",  iconText:"#fbbf24",  bar:"#fbbf24",  glow:"rgba(251,191,36,0.2)"  },
  emerald: { icon:"rgba(52,211,153,0.15)",  iconText:"#34d399",  bar:"#34d399",  glow:"rgba(52,211,153,0.2)"  },
  rose:    { icon:"rgba(244,114,182,0.15)", iconText:"#f472b6",  bar:"#f472b6",  glow:"rgba(244,114,182,0.2)" },
  cyan:    { icon:"rgba(6,182,212,0.15)",   iconText:"#06b6d4",  bar:"#06b6d4",  glow:"rgba(6,182,212,0.2)"   },
};
...
function KPIItem({ card }: { card: KPICard }) {
  ...
  return (
    <GlassCard glow={cfg.glow} className="group">
      ...
      <p className="text-[28px] font-display font-700 text-white tracking-tight leading-none mb-2">
        {card.formatted}
      </p>
      ...
      <div className="h-[3px] w-full rounded-full bg-white/[0.05] overflow-hidden">
        <div className="h-full rounded-full transition-all duration-1000" style={{ width:`${pct}%`, background: cfg.bar, boxShadow:`0 0 8px ${cfg.glow}` }} />
      </div>
    </GlassCard>
  );
}
